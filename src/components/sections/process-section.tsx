...
export function ProcessSection({
  ...
  return (
    <Section bordered={bordered}>
      ...
      <GlowGrid as="ol" className="mt-12 grid gap-px overflow-hidden rounded-xl border border-border bg-border md:grid-cols-2 lg:grid-cols-4">
        {steps.map((step, index) => (
          <Reveal as="li" key={step.step} delay={index * 0.06} className="bg-surface">
            <div data-glow className="glow-cell flex h-full flex-col p-7 md:p-8">
